<div>
    <x-app-layout>
        <x-slot name="header"><h2 class="font-semibold text-xl text-gray-800 leading-tight">Create Asset</h2></x-slot>
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                    <form wire:submit="save">
                        <div class="grid grid-cols-2 gap-4">
                            <div class="col-span-2"><h3 class="text-lg font-semibold mb-2">Basic Information</h3></div>
                            <div><label>Name *</label><input wire:model="name" type="text" class="w-full rounded-md border-gray-300" required />@error('name')<span class="text-red-500 text-sm">{{ $message }}</span>@enderror</div>
                            ...
                            <div class="col-span-2"><h3 class="text-lg font-semibold mb-2 mt-4">Maintenance Schedule</h3></div>
                            ...
                            <div><label>Frequency (Days) - for Custom</label><input wire:model="service_frequency_days" type="number" class="w-full rounded-md border-gray-300" /></div>

                            <div class="col-span-2"><h3 class="text-lg font-semibold mb-2 mt-4">Expiry & Purchase</h3></div>
                            <div><label>Expiry Date</label><input wire:model="expiry_date" type="date" class="w-full rounded-md border-gray-300" /></div>
                            <div><label>Warning Days Before Expiry</label><input wire:model="expiry_warning_days" type="number" value="30" class="w-full rounded-md border-gray-300" /></div>
                        ...
                        <div class="mt-6 flex justify-end space-x-2">
                            ...
                            <button type="submit" class="px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700">Create Asset</button>
                        </div>
                    </form>
                </div>
            </div>
